...
import { getChatMessagesAction, getChatsAction } from "../redux/actions/messages.action";
...
const Messages = () => {
    ...
    useEffect(() => {
        authDetails?._id && selectedChat?._id &&  dispatch(getChatMessagesAction(selectedChat?._id));
    ...
    return (
        <DashboardWrapper>
            ...
            <div className="p-4 flex divide-x-[1px] min-h-[600px]">
                <ChatUsers setSelectedChat={setSelectedChat} selectedChat={selectedChat} />
